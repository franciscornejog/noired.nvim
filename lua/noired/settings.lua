...
local M = {
    ...
    SignatureMarkText = { fg = colors.bright_blue, bg = colors.dark1, inverse = true },
    SignatureMarkerText = { fg = colors.bright_purple, bg = colors.dark1, inverse = true },
    ...
    TabLine = { fg = colors.dark4, bg = colors.dark1, inverse = true },
    TabLineFill = { fg = colors.dark4, bg = colors.dark1, inverse = true },
    TabLineSel = { fg = colors.bright_green, bg = colors.dark1, inverse = true },
    ...
    iCursor = { inverse = true },
    iitle = { fg = colors.bright_green, bold = true },
    lCursor = { inverse = true },
